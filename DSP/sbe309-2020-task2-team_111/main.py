...
class Equalizer(QMainWindow):
    ...
    def __init__(self):
        ...
        #########################Check Box################################
        self.Defult.setChecked(False)                                                 #Default
        self.Defult.stateChanged.connect(self.onClicked1)
        self.checkBox.setChecked(False)                                               #Hamming
        self.checkBox.stateChanged.connect(self.onClicked1)
        self.checkBox_2.setChecked(False)                                             #Hanning
        self.checkBox_2.toggled.connect(self.onClicked1)
        self.checkBox_3.setChecked(False)                                             #Rectangular
    ...
    ############################################### Hamming #################################################################  
    def defaultFFT_signal(self,g):
        if (self.controlled==0):
            self.defaul=np.fft.fft( self.arr_absBand_10)
        elif (self.controlled==1):
            self.defaul=np.fft.fft( self.arr_absBand_9)
        elif (self.controlled==2):
            self.defaul=np.fft.fft( self.arr_absBand_8)
        elif (self.controlled==3):
             self.defaul=np.fft.fft( self.arr_absBand_7)
        elif (self.controlled==4):
               self.defaul=np.fft.fft( self.arr_absBand_6)
        elif (self.controlled==5):
               self.defaul=np.fft.fft( self.arr_absBand_5)
        elif (self.controlled==6):
                self.defaul=np.fft.fft( self.arr_absBand_4)
        elif (self.controlled==7):
                self.defaul=np.fft.fft( self.arr_absBand_3)
        elif (self.controlled==8):
                self.defaul=np.fft.fft( self.arr_absBand_2)
        elif (self.controlled==9):
               self.defaul=np.fft.fft( self.arr_absBand_1)

        self.F_signal=np.fft.fft(self.defaul)
        self.mag_sig=np.abs(self.F_signal)

        #self.mag_sig[30000:]=0
        self.gain =g * (self.mag_sig)
        self.arr_Def=np.array(self.gain)
        #self.graphicsView.plot(self.mag_sig)   
    ...
    def PLOT_band_1(self):
        ...
        self.defaultFFT_signal(self.gs1)
        if (self.HammFlag==1):
            self.defultFlag=0
            self.HannFlag=0
            self.RecFlag=0
        ...
        elif(self.defultFlag==1):
            self.HammFlag=0
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_1=np.abs(self.arr_absBand_1* self.arr_Def)
            self.band_1=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_1) 
    ...
    def PLOT_band_2(self):
        ...
        self.defaultFFT_signal(self.gs2)
        if (self.HammFlag==1):
            self.defultFlag=0
            self.HannFlag=0
            self.RecFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_2=np.abs(self.arr_absBand_2* self.arr_Def)
            self.band_2=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_2) 
        elif(self.HannFlag==1):
            self.HammFlag=0
...
########################################### plot band 3 #####################################################################
    def PLOT_band_3(self):
        ...
        self.defaultFFT_signal(self.gs3)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.defultFlag=0
            self.RecFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_3=np.abs(self.arr_absBand_3* self.arr_Def)
            self.band_3=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_3) 
        elif(self.HannFlag==1):
            self.HammFlag=0
...
########################################### plot band 4 #####################################################################
    def PLOT_band_4(self):
        ...
        self.defaultFFT_signal(self.gs4)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.RecFlag=0
            self.defultFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_4=np.abs(self.arr_absBand_4* self.arr_Def)
            self.band_4=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_4) 
        elif(self.HannFlag==1):
            self.HammFlag=0
...
########################################### plot band 5 #####################################################################
    def PLOT_band_5(self):
        ...
        self.defaultFFT_signal(self.gs5)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.defultFlag=0
            self.RecFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_5=np.abs(self.arr_absBand_5* self.arr_Def)
            self.band_5=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_5)
        elif(self.HannFlag==1):
            self.HammFlag=0
...
########################################### plot band 6 #####################################################################
    def PLOT_band_6(self):
        ...
        self.defaultFFT_signal(self.gs6)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.defultFlag=0
            self.RecFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_6=np.abs(self.arr_absBand_6* self.arr_Def)
            self.band_6=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_6)
        elif(self.HannFlag==1):
            self.HammFlag=0
...
########################################### plot band 7 #####################################################################
    def PLOT_band_7(self):
        ...
        self.defaultFFT_signal(self.gs7)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.defultFlag=0
            self.RecFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_7=np.abs(self.arr_absBand_7* self.arr_Def)
            self.band_7=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_7)
        elif(self.HannFlag==1):
            self.HammFlag=0
 ...
 ########################################### plot band 8 #####################################################################
    def PLOT_band_8(self):
        ...
        self.defaultFFT_signal(self.gs8)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.RecFlag=0
            self.defultFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_8=np.abs(self.arr_absBand_8* self.arr_Def)
            self.band_8=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_8)
        elif(self.HannFlag==1):
            self.HammFlag=0
...
########################################### plot band 9 #####################################################################
    def PLOT_band_9(self):
        ...
        self.defaultFFT_signal(self.gs9)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.RecFlag=0
            self.defultFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_9=np.abs(self.arr_absBand_9* self.arr_Def)
            self.band_9=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_9)
        elif(self.HannFlag==1):
            self.HammFlag=0
    ...
    def PLOT_band_10(self):
        ...
        self.defaultFFT_signal(self.gs10)
        if (self.HammFlag==1):
            self.HannFlag=0
            self.defultFlag=0
            self.RecFlag=0
            ...
            self.HannFlag=0
            self.RecFlag=0
            self.mul_sig_10=np.abs(self.arr_absBand_10* self.arr_Def)
            self.band_10=np.concatenate([self.mul_sig_1,self.mul_sig_2,self.mul_sig_3,self.mul_sig_4,self.mul_sig_5,self.mul_sig_6,self.mul_sig_7,self.mul_sig_8,self.mul_sig_9,self.mul_sig_10])
            self.graphicsView.plot(self.band_10)
        elif(self.HannFlag==1):
            self.HammFlag=0
    ...
    def export(self):
        ...
        #print ('%d', self.abs_inv)
        #print ('%d', self.data_wav)
